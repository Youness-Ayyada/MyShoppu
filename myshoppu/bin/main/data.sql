...
insert into shop(id, name, active) values (0, 'OPPO', true);
insert into shop(id, name, active) values (1, 'SAMSUNG', true);
insert into shop(id, name, active) values (2, 'APPLE', true);
